...
namespace BulkExecutorSample
{
    class Program
    {
        private static readonly string EndpointUrl = File.ReadAllText(@"C:\apikeys\cosmos-db-gremlin\hostname.txt");
        private static readonly string AuthorizationKey = File.ReadAllText(@"C:\apikeys\cosmos-db-gremlin\authKey.txt");
        private static readonly string DatabaseName = File.ReadAllText(@"C:\apikeys\cosmos-db-gremlin\database.txt");
        private static readonly string CollectionName = File.ReadAllText(@"C:\apikeys\cosmos-db-gremlin\collection.txt");
