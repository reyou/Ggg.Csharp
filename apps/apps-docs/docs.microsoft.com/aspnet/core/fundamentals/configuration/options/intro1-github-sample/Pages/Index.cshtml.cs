...
namespace SampleApp.Pages
{
    public class IndexModel : PageModel
    {
        ...
        /// IOptionsSnapshot<TOptions> is useful in scenarios where options should be recomputed on every request. 
        /// </summary>
        /// <param name="optionsAccessor"></param>
        /// <param name="optionsAccessorWithDelegateConfig"></param>
        /// <param name="subOptionsAccessor"></param>
        /// <param name="snapshotOptionsAccessor"></param>
        /// <param name="namedOptionsAccessor"></param>
